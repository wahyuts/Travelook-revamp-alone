...
import LoginForm from "../components/underLoginPage/LoginForm";
...
const LoginPage = () => {
  ...
  return (
    //   {/** "bck" diambil dari class yang ada di css external BackgroundLoginPage.css*/}
    <div className="bck"> 
      <Grid container spacing={5}>
          ...
          <Grid item sm={6} xs={12} className={classes.loginForm}>
              <LoginForm/>
          </Grid>
      </Grid>
    </div>
